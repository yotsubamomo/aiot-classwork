...
- **Spec 版本**：**v2.2**（2026-09-25；v2.0 同日 derive，v2.1 與 v2.2 為 acceptor 指示的 DA 修正，見第 10 節版本紀錄；2026-09-26 §5.3 儀器註記的 km↔px 換算數值依 DV-23 更正，版本不變）
...
| R-V2-MAP-3 上限 | `maxZoom` ＝ 12（可接受 12–13；Web Mercator、23.5°N：z12 時 1 km ≈ 28.5 px、375 px 視窗 ≈ 13 km；z13 時 ≈ 57 px、≈ 6.6 km 亦 PASS；z11 時 1 km ≈ 14.3 px FAIL；z14 時 375 px ≈ 3.3 km FAIL。〔DV-23 更正 2026-09-26：原文 24 px／16 km／12 px／4 km 的 km↔px 換算有誤；各 zoom 的 PASS／FAIL 判定不變〕） | 上限時 1 km ≥ 20 CSS px 且 375 px 視窗 ≥ 5 km；臺北市測站可個別選取 |
...
| R-V2-RAD-5 對齊 | 參考點：產品範圍四角、四邊中點、中心，加本島內 ≥ 3 點；zoom 7 與 10 | 每點誤差 ≤ 1 km（oracle 是**地面距離**；換算 px 只是該 zoom 的讀數尺度——Web Mercator、lat 20.5–26.5：z7 ≈ 0.87–0.91 px、z10 ≈ 6.98–7.31 px，23.5°N 各約 0.89／7.13 px；以 zoom 10 為主要判定，zoom 7 作粗檢，因 z7 時 1 CSS px ≈ 1.1 km、容差小於 1 px。〔DV-23 更正 2026-09-26：原文 z7 ≈ 0.35 px、z10 ≈ 2.8 px 有誤〕） |
...
| v2.2（annotation correction） | 2026-09-26 | §5.3 R-V2-RAD-5 列與 R-V2-MAP-3 列的 km↔px 換算註記更正為 Web Mercator（EPSG:3857，R ＝ 6378137、256 px tile）在臺灣緯度的正確值：1 km 於 z7 0.35 → ≈ 0.89 px、z10 2.8 → ≈ 7.13 px、z12 24 → ≈ 28.5 px（23.5°N），及其衍生的 375 px 視窗於 z12 16 → ≈ 13 km、z11 12 → ≈ 14.3 px、z14 4 → ≈ 3.3 km；標頭「Spec 版本」列加註。來源：Issue #40 c1 R1 routing signal R-1；decision record [`../governance/decisions/decision-20260926-spec-5-3-pixel-figure-correction.md`](../governance/decisions/decision-20260926-spec-5-3-pixel-figure-correction.md)（DV-23）。 | 治理 §5.3 第 2 類：非規範儀器註記的數值更正（§0 標記約定：儀器不是產品語義；此處連儀器值——1 km、≥ 20 px、≥ 5 km、`minZoom` 6、`maxZoom` 12、E、參考點、zoom 7／10——都不變）；不改任何 R、AC、INV、oracle、證據類別，不改 #39／#40 任何 PASS／FAIL；版本不變，比照「v2.2（metadata）」列。 |
