...
| --- | --- | --- | --- | --- |
| #35 | **audit 中 (R2)** | `08e158e..50ecdbf` (code anchor `5f0dbc3`) | R1 BLOCKING (F-1) → correction → R2 dispatched | V2 Core; server-side Latest Observation `/api/`, 4 failure classes, security re-scope; H-1/H-2/H-3 |
