...
- 執行順序為單鏈（Bindings §6 並行度 1）；#40 Radar 排在 #39 圍欄之後，使對齊所需的 CRS／重投影變更能在 #40 內重驗 AC-V2-13／15。

## Artifacts

| 動作 | 路徑／識別 | 作者 |
| --- | --- | --- |
| 新增 | GitHub Issues #35–#41（`yotsubamomo/aiot-classwork`，label `ready-for-agent`，原生 blocked-by 6 條邊） | Design Authority |
...
- Issues：`gh issue list` 顯示 #35–#41 皆 open、label `ready-for-agent`；API `dependencies/blocked_by`：#36←#35；#37←#36；#38←#37；#39←#38；#40←#39；#41←#40（#35 無）。
