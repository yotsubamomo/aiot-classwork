...
| #24 F-5 | 375px east-marker popup clipping / sidebar reset / south outline | Low | Map UX detail; no contract clause violated. **F-5(a) tooltip clipping RESOLVED in #28** — per-marker tooltip direction keeps all six tooltips fully visible at 375 & desktop (V-3 measured). The south-outline note is moot: the project-authored outline is replaced by the vendored MOI county polygons. |
